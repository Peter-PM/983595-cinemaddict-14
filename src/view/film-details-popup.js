export const createFilmPopupTemplate = (filmCard) => {
  ...
  const activeFavorite = isFavorite ? 'checked' : '' ;
    ...
    <form class="film-details__inner" action="" method="get">
      <div class="film-details__top-container">
        ...
        <div class="film-details__info-wrap">
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              <tr class="film-details__row">
                <td class="film-details__term">${createPluralGenre()}</td>
        ...
        <section class="film-details__controls">
          <input type="checkbox" class="film-details__control-input visually-hidden" id="watchlist" name="watchlist" ${activeWatchlist}>
          <label for="watchlist" class="film-details__control-label film-details__control-label--watchlist">Add to watchlist</label>

          <input type="checkbox" class="film-details__control-input visually-hidden" id="watched" name="watched" ${activeWatched}>
          <label for="watched" class="film-details__control-label film-details__control-label--watched">Already watched</label>

          <input type="checkbox" class="film-details__control-input visually-hidden" id="favorite" name="favorite" ${activeFavorite}>
